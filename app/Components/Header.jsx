...
const Header = () => {
  ...
  return (
    <div id="home" className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      <motion.h3 initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration: 1, delay: 0.4}} className='flex item-end gap-1.5 font-Ovo text-xl md:text-2xl mb-3 '>Hey! I'm Abhay Chaskar <PiHandPeace size={27}/></motion.h3>
      <motion.h3 initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration: 0.8, delay: 0.6}} className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>Frontend/UI Developer</motion.h3>
      <motion.p initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration: 0.6, delay: 0.8}} className='max-w-2xl mx-auto'>I have over 4 years of full-time experience in the IT industry, where I have developed and managed SPAs using ReactJS and related libraries or frameworks.</motion.p>
