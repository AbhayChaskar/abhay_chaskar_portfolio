  ...
  return (
    <div id="home" className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
        <a href='' className='py-2.5 px-6 w-max flex items-center gap-2 justify-between bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:border-none dark:bg-white/80 dark:hover:bg-white dark:duration-500 dark:text-black' onClick={handleConnectButton}>Let's Connect <IoIosArrowDropright size={20}/></a>
      </div>
    </div>
  )
}
