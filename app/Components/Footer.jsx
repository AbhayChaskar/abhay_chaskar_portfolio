  ...
  return (
    <div className='mt-12'>
        ...
        <div className='text-center sm:flex items-center justify-between border-t border-gray-500 mx-[10%] mt-10 py-6'> 
            <p className='flex items-center gap-1 text-black/80 dark:text-white/80'><FaRegCopyright size={20} className='text-black/80 dark:text-white/80'/> 2025. Designed & Developed by <a href="https://www.linkedin.com/in/abhayrc05" target='_blank' className="text-blue-500">Abhay Chaskar</a>.</p>
